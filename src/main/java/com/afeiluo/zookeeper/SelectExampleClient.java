 ...
 */
public class SelectExampleClient extends LeaderSelectorListenerAdapter implements Closeable {
    private final String name;
    private final LeaderSelector leaderSelector;
    private final AtomicInteger leaderCount = new AtomicInteger();

    public SelectExampleClient(CuratorFramework client, String path, String name) {
        this.name = name;
